...
public class BusScheduleHeaderController {
    ...
    public ResponseEntity<Void> saveHeader(@RequestBody Map<String, Object> body) throws JsonProcessingException {
        ...
        List<String> stopOrder = (List<String>) body.get("stopOrder");
    ...
    public ResponseEntity<List<String>> getHeader(@RequestParam String routeId) throws JsonProcessingException {
